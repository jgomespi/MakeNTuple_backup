...
process.load("Validation.CTPPS.simu_config.base_cff")
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring("file:/eos/home-j/jgomespi/workspace/ntuplas_signal/MuMu_preVFP_0.0_8e-06_numEvent100000.root"),#
