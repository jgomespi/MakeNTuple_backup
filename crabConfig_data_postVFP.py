...
config.JobType.psetName = 'ConfFile_data_postVFP_cfg.py'
...
config.Data.inputDataset = '/SingleMuon/Run2016G-21Feb2020_UL2016-v1/MINIAOD'
submit(config)

config.General.requestName = 'SingleMuon_H'
...
config.General.requestName = 'SingleElectron_H'
