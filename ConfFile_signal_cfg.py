...
DATA=cms.bool(False)
preVPF=cms.bool(True)
postVPF=cms.bool(False)
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring("file:signal_preVFP.root"),#
...
#process.ctppsLHCInfoRandomXangleESSource.xangle = 185. 
...
process.cleanPatElectrons = cms.EDProducer("PATElectronCleaner",
    ...
    preselection = cms.string("electronID('cutBasedElectronID-Fall17-94X-V1-tight') && pt() > 50. && abs(eta()) < 2.4"), #electronID('egmGsfElectronIDs:cutBasedElectronID-Summer16-80X-V1-tight
    # overlap checking configurables
    checkOverlaps = cms.PSet(),
